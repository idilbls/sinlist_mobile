...
import 'package:sinlist_mobile/core/config/app_settings.dart';
...
class ApiProvider {
  ...
  Future<dynamic> get(
    ...
    try {
      ...
      /****** Caching ******/
      if (uri != 'TokenAuth/Authenticate')
        _dio.options.headers["Authorization"] = "Bearer " + await SecureStorage.instance.read(Constants.AUTH_TOKEN);
